...
@Configuration
@EnableJpaRepositories(basePackages = {"br.brpltrade.*"})
@ComponentScan(basePackages = { "br.brpltrade.*" })
...
public class PersistenceContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(Environment env) {
		...
		em.setPackagesToScan("br.jpa.*", "br.brpltrade.jpa.*", "br.brpltrade.entity");
