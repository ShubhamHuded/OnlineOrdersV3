...
{ 
  ...
  var fullLink = "class=\"test-test\" href=\""+this.link+"\" target=\""+this.target+"\" onClick=\"clickOnLink('"+this.getID()+"\', '"+this.link+"','"+this.target+"');return false;\"";
  this.isRendered = 1
...
{ 
  ...
  if(image!=undefined && image!=''){
  	folder.iconSrc = image
  	folder.iconSrcClosed = image
  }
  return folder;
} 
