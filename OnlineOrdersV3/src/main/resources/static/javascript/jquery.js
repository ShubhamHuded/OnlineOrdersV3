  ...
  function (a, b) {
    ...
    n.extend({
      ...
      isPlainObject: function (a) {
        ...
        if (
          ...
          !k.call(a.constructor.prototype || {
          }, 'isPrototypeOf')
        ) return !1;
        for (b in a);
        return void 0 === b ||
    ...
    var t = function (a) {
      ...
      ca = function (a, b, c) {
        var d = '0x' + b - 65536;
        return d !== d ||
        c ? b : 0 > d ? String.fromCharCode(d + 65536) : String.fromCharCode(d >> 10 | 55296, 1023 & d | 56320)
      },
      da = function () {
        m()
      };
      ...
      m = fa.setDocument = function (a) {
        ...
        g.documentElement ? (
          ...
          t = b ||
          Z.test(o.contains) ? function (a, b) {
          ...
          B = b ? function (a, b) {
            ...
            return d ? d : (
              ...
              1 & d ||
              !c.sortDetached &&
              b.compareDocumentPosition(a) === d ? a === n ||
              a.ownerDocument === v &&
              t(v, a) ? - 1 : b === n ||
              b.ownerDocument === v &&
              t(v, b) ? 1 : k ? J(k, a) - J(k, b) : 0 : 4 & d ? - 1 : 1
            )
          }
           : function (a, b) {
            if (a === b) return l = !0,
      ...
      fa.attr = function (a, b) {
        ...
        f = e &&
        D.call(d.attrHandle, b.toLowerCase()) ? e(a, b, !p) : void 0;
          ...
          ATTR: function (a, b, c) {
            return function (d) {
              ...
              return null == e ? '!=' === b : b ? (
                ...
                0 === e.indexOf(c) : '*=' === b ? c &&
                e.indexOf(c) > - 1 : '$=' === b ? c &&
                e.slice( - c.length) === c : '~=' === b ? (' ' + e.replace(P, ' ') + ' ').indexOf(c) > - 1 : '|=' === b ? e === c ||
                e.slice(0, c.length + 1) === c + '-' : !1
              ) : !0
            }
          },
          ...
          lang: ha(
            function (a) {
              ...
              function (b) {
                var c;
                do if (
                  c = p ? b.lang : b.getAttribute('xml:lang') ||
                  b.getAttribute('lang')
      ...
      g = fa.tokenize = function (a, b) {
        ...
        while (h) {
          ...
          for (g in d.filter) !(e = W[g].exec(h)) ||
          j[g] &&
          !(e = j[g](e)) ||
          (
            c = e.shift(),
    ...
    n.filter = function (a, b, c) {
      ...
      (a = ':not(' + a + ')'),
      1 === b.length &&
      1 === d.nodeType ? n.find.matchesSelector(d, a) ? [
        d
    ...
    C = n.fn.init = function (a, b, c) {
      ...
      if (c = c || A, 'string' == typeof a) {
        ...
        if (e[1]) {
          if (
            ...
            n.merge(this, n.parseHTML(e[1], b && b.nodeType ? b.ownerDocument ||
            b : d, !0)),
            x.test(e[1]) &&
            n.isPlainObject(b)
      ...
      return a.nodeType ? (this.context = this[0] = a, this.length = 1, this) : n.isFunction(a) ? void 0 !== c.ready ? c.ready(a) : a(n) : (
        void 0 !== a.selector &&
    ...
    n.fn.extend({
      ...
      closest: function (a, b) {
        for (
          ...
          f = [],
          g = w.test(a) ||
          'string' != typeof a ? n(a, b || this.context) : 0;
          e > d;
          d++
        ) for (c = this[d]; c && c !== b; c = c.parentNode) if (
          c.nodeType < 11 &&
      ...
      index: function (a) {
        return a ? 'string' == typeof a ? h.call(n(a), this[0]) : h.call(this, a.jquery ? a[0] : a) : this[0] &&
    ...
    n.Callbacks = function (a) {
      ...
      i = function () {
        for (e = a.once, d = b = !0; g.length; h = - 1) {
          c = g.shift();
          while (++h < f.length) f[h].apply(c[0], c[1]) === !1 &&
          a.stopOnFalse &&
          (h = f.length, c = !1)
        }
        a.memory ||
      ...
      j = {
        add: function () {
          ...
          (
            c &&
            !b &&
            (h = f.length - 1, g.push(c)),
            function d(b) {
              n.each(
                b,
                function (b, c) {
                  n.isFunction(c) ? a.unique &&
                  j.has(c) ||
                  f.push(c) : c &&
                  c.length &&
                  'string' !== n.type(c) &&
    ...
    n.extend({
                  ...
                  function (b, f) {
                    ...
                    e[f[1]](
                      function () {
                        ...
                        a &&
                        n.isFunction(a.promise) ? a.promise().progress(c.notify).done(c.resolve).fail(c.reject) : c[f[0] + 'With'](this === d ? c.promise() : this, g ? [
                          a
                        ] : arguments)
                      }
                    )
      ...
      when: function (a) {
        ...
        f = 1 !== d ||
        a &&
        n.isFunction(a.promise) ? d : 0,
        g = 1 === f ? a : n.Deferred(),
        h = function (a, b, c) {
          return function (d) {
            b[a] = this,
            c[a] = arguments.length > 1 ? e.call(arguments) : d,
            c === i ? g.notifyWith(b, c) : --f ||
            g.resolveWith(b, c)
          }
        },
        i,
        j,
        k;
        if (d > 1) for (i = new Array(d), j = new Array(d), k = new Array(d); d > b; b++) c[b] &&
        n.isFunction(c[b].promise) ? c[b].promise().progress(h(b, j, i)).done(h(b, k, c)).fail(g.reject) : --f;
        return f ||
        g.resolveWith(k, c),
        g.promise()
      }
    ...
    M.prototype = {
      ...
      access: function (a, b, c) {
        ...
        b &&
        'string' == typeof b &&
        void 0 === c ? (d = this.get(a, b), void 0 !== d ? d : this.get(a, n.camelCase(b))) : (this.set(a, b, c), void 0 !== c ? c : b)
      },
      remove: function (a, b) {
        var c,
        d,
    ...
    n.extend({
      queue: function (a, b, c) {
        ...
        return a ? (
          ...
          d = N.get(a, b),
          c &&
          (!d || n.isArray(c) ? d = N.access(a, b, n.makeArray(c)) : d.push(c)),
          d ||
          []
        ) : void 0
      },
    ...
    n.fn.extend({
      queue: function (a, b) {
        ...
        (b = a, a = 'fx', c--),
        arguments.length < c ? n.queue(this[0], a) : void 0 === b ? this : this.each(
          function () {
    ...
    function ca(a, b, c, d, e) {
      for (
        ...
        p > o;
        o++
      ) if (f = a[o], f || 0 === f) if ('object' === n.type(f)) n.merge(m, f.nodeType ? [
        f
      ] : f);
       else if (ba.test(f)) {
        g = g ||
        l.appendChild(b.createElement('div')),
        h = (Y.exec(f) || [
          '',
          ''
        ]) [1].toLowerCase(),
      ...
      l.textContent = '',
      o = 0;
      while (f = m[o++]) if (d && n.inArray(f, d) > - 1) e &&
      e.push(f);
       else if (
    ...
    n.event = {
      ...
      special: {
        ...
        focus: {
          trigger: function () {
            return this !== ia() &&
            this.focus ? (this.focus(), !1) : void 0
          },
    ...
    function pa(a, b) {
      ...
      n.nodeName(11 !== b.nodeType ? b : b.firstChild, 'tr') ? a.getElementsByTagName('tbody') [0] ||
    ...
    function ta(a, b) {
      var c = b.nodeName.toLowerCase();
      'input' === c &&
      X.test(a.type) ? b.checked = a.checked : 'input' !== c &&
      'textarea' !== c ||
    ...
    function ua(a, b, c, d) {
      ...
      q = b[0],
      r = n.isFunction(q);
      if (r || o > 1 && 'string' == typeof q && !l.checkClone && ma.test(q)) return a.each(
        function (e) {
          var f = a.eq(e);
          r &&
    ...
    function Pa(a, b, c) {
      ...
      if (0 >= e || null == e) {
        ...
        d = g &&
        (l.boxSizingReliable() || e === a.style[b]),
        e = parseFloat(e) ||
        0
      }
    ...
    n.extend({
      ...
      css: function (a, b, c, d) {
        ...
        (e = Ja[b]),
        '' === c ||
        c ? (f = parseFloat(e), c === !0 || isFinite(f) ? f ||
        0 : e) : e
      }
    }),
    n.each(
      ...
      function (a, b) {
        n.cssHooks[b] = {
          get: function (a, c, d) {
            ...
            0 === a.offsetWidth ? Da(a, Ia, function () {
              return Pa(a, b, d)
            }) : Pa(a, b, d) : void 0
          },
          set: function (a, c, d) {
    ...
    n.cssHooks.marginLeft = Ga(
      ...
      function (a, b) {
        return b ? (
          ...
          a.getBoundingClientRect().left - Da(
            a,
            {
              marginLeft: 0
            },
    ...
    Ra.prototype = {
      ...
      cur: function () {
        ...
        return a &&
        a.get ? a.get(this) : Ra.propHooks._default.get(this)
      },
      run: function (a) {
        var b,
        ...
        c &&
        c.set ? c.set(this) : Ra.propHooks._default.set(this),
        this
      }
    },
    ...
    Ra.propHooks = {
      _default: {
        get: function (a) {
          ...
          null != a.elem[a.prop] &&
          null == a.elem.style[a.prop] ? a.elem[a.prop] : (b = n.css(a.elem, a.prop, ''), b && 'auto' !== b ? b : 0)
        },
        set: function (a) {
    ...
    function Za(a, b, c) {
      ...
      if (n.isEmptyObject(m)) 'inline' === ('none' === j ? za(a.nodeName) : j) &&
      (o.display = j);
       else {
        q ? 'hidden' in q &&
        (p = q.hidden) : q = N.access(a, 'fxshow', {
        }),
        f &&
        (q.hidden = !p),
    ...
    function _a(a, b, c) {
      ...
      k = j.props;
      for ($a(k, j.opts.specialEasing); g > f; f++) if (d = _a.prefilters[f].call(j, a, k, j.opts)) return n.isFunction(d.stop) &&
    ...
    n.each(
      ...
      function (a, b) {
        ...
        n.fn[b] = function (a, d, e) {
          return null == a ||
          'boolean' == typeof a ? c.apply(this, arguments) : this.animate(Xa(b, !0), a, d, e)
        }
      }
    ),
    n.each({
    ...
    n.extend({
      attr: function (a, b, c) {
        ...
        if (3 !== f && 8 !== f && 2 !== f) return 'undefined' == typeof a.getAttribute ? n.prop(a, b, c) : (
          ...
          void 0 !== c ? null === c ? void n.removeAttr(a, b) : e &&
          'set' in e &&
      ...
      propHooks: {
        tabIndex: {
          get: function (a) {
            ...
            return b ? parseInt(b, 10) : cb.test(a.nodeName) ||
            db.test(a.nodeName) &&
            a.href ? 0 : - 1
          }
        }
    ...
    n.fn.extend({
      ...
      toggleClass: function (a, b) {
        ...
        'string' === c ? b ? this.addClass(a) : this.removeClass(a) : n.isFunction(a) ? this.each(
          function (c) {
    ...
    n.fn.extend({
      val: function (a) {
        ...
        e = this[0];
        {
          ...
          b &&
          'get' in b &&
          void 0 !== (c = b.get(e, 'value')) ? c : (c = e.value, 'string' == typeof c ? c.replace(gb, '') : null == c ? '' : c)
        }
      }
    }),
    n.extend({
    ...
    n.extend({
      ...
      ajax: function (b, c) {
        ...
        m,
        p = m.context &&
        (o.nodeType || o.jquery) ? n(o) : n.event,
        q = n.Deferred(),
        ...
        x.setRequestHeader(
          'Accept',
          m.dataTypes[0] &&
          m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ('*' !== m.dataTypes[0] ? ', ' + ub + '; q=0.01' : '') : m.accepts['*']
        );
        ...
        function z(b, c, d, h) {
          ...
          (
            ...
            j ? (
              ...
              204 === b ||
              'HEAD' === m.type ? y = 'nocontent' : 304 === b ? y = 'notmodified' : (y = u.state, l = u.data, t = u.error, j = !t)
    ...
    function Gb(a, b, c, d) {
      ...
      if (n.isArray(b)) n.each(
        ...
        function (b, e) {
          c ||
          Cb.test(a) ? d(a, e) : Gb(a + '[' + ('object' == typeof e && null != e ? b : '') + ']', e, c, d)
        }
      );
    ...
    n.ajaxPrefilter(
      ...
      function (b, c, d) {
        ...
        h = b.jsonp !== !1 &&
        (
          Kb.test(b.url) ? 'url' : 'string' == typeof b.data &&
        ...
        'jsonp' === b.dataTypes[0] ? (
          ...
          h ? b[h] = b[h].replace(Kb, '$1' + e) : b.jsonp !== !1 &&
    ...
    n.fn.load = function (a, b, c) {
      ...
      h = a.indexOf(' ');
      return h > - 1 &&
      (d = n.trim(a.slice(h)), a = a.slice(0, h)),
      n.isFunction(b) ? (c = b, b = void 0) : b &&
      'object' == typeof b &&
      (e = 'POST'),
      g.length > 0 &&
      n.ajax({
    ...
    function Mb(a) {
      return n.isWindow(a) ? a : 9 === a.nodeType &&
      a.defaultView
    }
    n.offset = {
